...
// Register Method
export const postFakeRegister = (data : any) => api.create(url.POST_REGISTER, data);
...
// postForgetPwd
export const postJwtForgetPwd = (data : any) => api.create(url.POST_JWT_RESET_PASSWORD, data);
...
// update Invoice
export const updateInvoice = (invoice : any) => api.update(url.UPDATE_INVOICE, invoice);

// delete Invoice
export const deleteInvoice = (invoice : any) => api.delete(url.DELETE_INVOICE, { headers: {invoice}});
