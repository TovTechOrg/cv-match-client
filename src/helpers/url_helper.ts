...
export const POST_REGISTER = "http://localhost:5000/api/register";

//LOGIN
export const POST_FAKE_LOGIN = "/auth/signin";
// export const POST_FAKE_JWT_LOGIN = "/post-jwt-login";
export const POST_JWT_LOGIN = "http://localhost:5000/api/login";
export const POST_PASSWORD_FORGET = "/auth/forgot-password";
// export const POST_JWT_PASSWORD_FORGET = "/jwt-forget-pwd";
export const POST_JWT_RESET_PASSWORD = "http://localhost:5000/api/reset-password";
