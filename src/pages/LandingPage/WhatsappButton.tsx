...
const WhatsAppButton = () => {
  return (
    <Container
      ...
      style={{ width: "650.63px", height: "91.5373px" }}
    >
      <Row
      ...
      <div
        className="position-absolute start-0 d-flex align-items-center justify-content-center"
        style={{ width: "91.3085px", height: "91.5373px" }}
      >
        <div
          className="position-absolute start-0 d-flex align-items-center justify-content-center"
          style={{ width: "91.3085px", height: "91.5373px" }}
          ...
          >
            ...
            >
              <svg
                ...
                fill-rule="evenodd"
                clip-rule="evenodd"
                viewBox="1 0 510 512.459"
                style={{ fill: "#0097b2", stroke: "#0097b2" }}
              >
                {/* White background circle with a larger border */}
                <circle
                  cx="255"
                  cy="255"
                  r="222"
