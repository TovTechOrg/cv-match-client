...
const FileManager = () => {
    document.title = "File Manager | PythiaMatch - AI for recruiters";
    ...
    const fileCategory = (e: any, ele: any) => {
        setFilterActive(ele);
        let folderList: any = document.getElementById("folder-list");
    ...
    const fileSidebar = () => {
        let folderOverview: any = document.getElementById("folder-overview");
        let fileOverview: any = document.getElementById("file-overview");
                ...
                <Container fluid>
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                            ...
                            <div className="mx-n3 pt-4 px-4 file-manager-content-scroll overflow-x-hidden overflow-y-auto">
                                ...
                                <div>
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <div className="flex-shrink-0">
                                            <button className="btn btn-primary createFile-modal" onClick={() => handleFileClicks()}><i className="ri-add-line align-bottom me-1"></i> Create File</button>
                                        </div>
                                    </div>
                        ...
                        <div className="file-manager-detail-content p-3 py-0">
                            <div className="mx-n3 pt-3 px-3 file-detail-content-scroll">
