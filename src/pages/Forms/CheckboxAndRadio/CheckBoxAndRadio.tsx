...
const CheckBoxAndRadio = () => {
    document.title = "Checkbox & Radio | PythiaMatch - AI for recruiters";
                ...
                <Container fluid>
                    ...
                    <Row>
                        <div className="col-12">
                            <Card>
                                <PreviewCardHeader title="Custom Checkboxes" />
                                <CardBody>
                                    <div className="live-preview">
                                        <Row>
                                            <Col md={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <PreviewCardHeader title="Radios" />
                                <CardBody>
                                    <div className="live-preview">
                                        <Row>
                                            <Col lg={4} md={6}>
                    ...
                    <Row>
                        <div className="col-12">
                            <Card >
                                <PreviewCardHeader title="Switches Color" />
