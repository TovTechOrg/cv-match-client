...
const ExploreNow = () => {
    document.title = "Explore Now | PythiaMatch - AI for recruiters";
    ...
    const searchNFT = () => {
        ...
        let noresult: any = document.getElementById("noresult")
        let loadmore: any = document.getElementById("loadmore")
