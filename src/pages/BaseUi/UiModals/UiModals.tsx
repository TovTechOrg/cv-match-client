...
const UiModals = () => {
    document.title = "Modals | PythiaMatch - AI for recruiters";
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>modal-dialog</code>class to show default modal.</p>
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>data-bs-backdrop="static" </code> cto modal not to close when clicking outside the modal.</p>
                                    <div className="live-preview">
                                        <div>
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>Tooltips and Popovers can be placed within modals as needed.When modals are closed, any tooltips and popovers within are also automatically dismissed.                             </p>
                                    <div className="live-preview">
                    ...
                    <form action="#">
                        <div className="row g-3">
                            ...
                            <Col xxl={6}>
                                ...
                                <Input type="password" className="form-control" id="passwordInput" placeholder="Enter password" value="451326546" readOnly />
                            </Col>
                            <Col lg={12}>
