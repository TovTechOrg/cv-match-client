...
const UiAlerts = () => {
    document.title="Alerts | PythiaMatch - AI for recruiters";
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-dismissible</code> class to add dismissing button to the alert.
                                    </p>
                                    <div className="live-preview">
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                <h6>Primary Alert</h6>
                                                <UncontrolledAlert color="primary" className="alert alert-primary alert-dismissible bg-primary text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> -Label icon alert
                                                </UncontrolledAlert>

                                                <h6>Secondary Alert</h6>
                                                <UncontrolledAlert color="secondary" className="alert alert-secondary alert-dismissible bg-secondary text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                ...
                                                <h6>Success Alert</h6>
                                                <UncontrolledAlert color="success" className="alert alert-success alert-dismissible bg-success text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className="alert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0" closeClassName="btn-close-white">
                                            ...
                                            <Col xl={6}>
                                                <h6>Warning Alert</h6>
                                                <UncontrolledAlert color="warning" className="alert alert-warning alert-dismissible bg-warning text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-alert-line label-icon"></i><strong>warning</strong> - Label
                                                    icon alert
                                                </UncontrolledAlert>

                                                <h6>Info Alert</h6>
                                                <UncontrolledAlert color="info" className="alert alert-info alert-dismissible bg-info text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Label
                                                    icon alert
                                                </UncontrolledAlert>

                                                <h6>Light Alert</h6>
                                                <UncontrolledAlert color="light" className="alert alert-light alert-dismissible bg-light text-body alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-mail-line label-icon"></i><strong>Light</strong> -
                                                    Label icon alert
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert alert-dark alert-dismissible bg-dark text-white alert-label-icon fade show mb-0" closeClassName="btn-close-white">
