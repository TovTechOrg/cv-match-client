...
const HeatmapCharts = () => {
    document.title = "Heatmap Charts | PythiaMatch - AI for recruiters";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <MultipleHeatmap dataColors='["--vz-primary", "--vz-secondary", "--vz-success", "--vz-info", "--vz-warning", "--vz-danger", "--vz-dark", "--vz-primary"]' />
                                </CardBody>
                            </Card>
                        </Col>
